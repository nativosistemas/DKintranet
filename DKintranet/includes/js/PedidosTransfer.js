...
function CargarRespuestaDePedidoTransfer(pValor) {
    ...
    if (pValor != null) {
        if (pValor.length > 0) {
            ...
            //                if (sucursal == 'CC') {
            //                    strHtmlMensajeFinales = '<div style="font-size: 14px;text-align:left;margin-top:10px;">' + 'Transfers a Revisión. Se ha generado un mail a pedidos@DKintranet.com.ar' + ' </div>';
            //                } else {
