...
namespace DKintranet.Codigo
{
    ...
    public partial class tbl_Recall
    {
        ...
        public string descripcionReducidoMostrar
        {
            ...
            get { return this.rec_descripcionReducido == null ? string.Empty : DKintranet.Codigo.clases.Generales.Texto.CortarBajada(this.rec_descripcionReducido, 120); }
            set { }
        }
        public string descripcionReducidoMostrarMediano
        {

            get { return this.rec_descripcionReducido == null ? string.Empty : DKintranet.Codigo.clases.Generales.Texto.CortarBajada(this.rec_descripcionReducido,380); }
            set { }
        }
