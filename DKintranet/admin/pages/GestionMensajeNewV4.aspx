<%@ Page Title="" Language="C#" MasterPageFile="~/master/BaseAdmin.Master" AutoEventWireup="true" CodeBehind="GestionMensajeNewV4.aspx.cs" Inherits="DKintranet.admin.pages.GestionMensajeNewV4" %>
        ...
        <ContentTemplate>
            <asp:Panel ID="pnl_grilla" runat="server">
                ...
                <asp:ObjectDataSource ID="odsMensaje" runat="server" SortParameterName="sortExpression"
                    SelectMethod="GetMensajesV4" TypeName="DKintranet.Codigo.clases.AccesoGrilla">
                    <SelectParameters>
