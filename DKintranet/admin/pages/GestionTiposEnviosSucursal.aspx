<%@ Page Title="" Language="C#" MasterPageFile="~/master/BaseAdmin.Master" AutoEventWireup="true" CodeBehind="GestionTiposEnviosSucursal.aspx.cs" Inherits="DKintranet.admin.pages.GestionTiposEnviosSucursal" %>
    ...
    <asp:UpdatePanel ID="up_general" runat="server">
        <ContentTemplate>
            <asp:ObjectDataSource ID="ObjectDataSourceTiposEnvios" runat="server" SortParameterName="sortExpression"
                SelectMethod="GetTiposEnviosSucursal" TypeName="DKintranet.Codigo.clases.AccesoGrilla">
                <SelectParameters>
