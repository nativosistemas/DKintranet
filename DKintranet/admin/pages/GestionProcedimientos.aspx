<%@ Page Title="" Language="C#" MasterPageFile="~/master/BaseAdmin.Master" AutoEventWireup="true" CodeBehind="GestionProcedimientos.aspx.cs" Inherits="DKintranet.admin.pages.GestionProcedimientos" %>
            ...
            <asp:Panel ID="panelBotonesSicronizar" runat="server">
                ...
                <asp:Panel ID="pnl_grilla" runat="server" Width="600">
                    ...
                    <asp:ObjectDataSource ID="odsHistoricos" runat="server" SortParameterName="sortExpression"
                        ...
                        TypeName="DKintranet.Codigo.clases.AccesoGrilla">
                        <SelectParameters>
