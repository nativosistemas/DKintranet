<%@ Page Title="" Language="C#" MasterPageFile="~/master/BaseAdmin.Master" AutoEventWireup="true" CodeBehind="GestionHorarioSucursal.aspx.cs" Inherits="DKintranet.admin.pages.GestionHorarioSucursal" %>
    ...
    <asp:UpdatePanel ID="up_general" runat="server">
        <ContentTemplate>
            ...
            <asp:ObjectDataSource ID="odsSucursalDependiente" runat="server" SelectMethod="CargarComboSucursalesDependiente"
                TypeName="DKintranet.Codigo.clases.cBaseAdmin" OnSelected="odsSucursalDependiente_Selected">
            </asp:ObjectDataSource>
            <asp:ObjectDataSource ID="odsCodigoReparto" runat="server" SelectMethod="CargarComboTodosCodigoReparto"
                TypeName="DKintranet.Codigo.clases.cBaseAdmin">
            </asp:ObjectDataSource>
