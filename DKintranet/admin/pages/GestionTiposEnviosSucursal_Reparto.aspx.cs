...
namespace DKintranet.admin.pages
{
    public partial class GestionTiposEnviosSucursal_Reparto : cBaseAdmin
    {
        ...
        public void AgregarHtmlOculto()
        {
            ...
            resultado += "<input type=\"hidden\" id=\"hiddenListaTipoEnvio\" value=\"" + Server.HtmlEncode(DKintranet.Codigo.clases.Generales.Serializador.SerializarAJson(listaTipoEnvio)) + "\" />";
            resultado += "<input type=\"hidden\" id=\"hiddenSucursalDependienteTipoEnvios\" value=\"" + Server.HtmlEncode(DKintranet.Codigo.clases.Generales.Serializador.SerializarAJson(obj)) + "\" />";
            resultado += "<input type=\"hidden\" id=\"hiddenListaTodosTiposEnvios\" value=\"" + Server.HtmlEncode(DKintranet.Codigo.clases.Generales.Serializador.SerializarAJson(l_Envios)) + "\" />";
            resultado += "<input type=\"hidden\" id=\"hiddenListaTodosCodigoReparto\" value=\"" + Server.HtmlEncode(DKintranet.Codigo.clases.Generales.Serializador.SerializarAJson(l_Reparto)) + "\" />";
