<%@ Page Title="" Language="C#" MasterPageFile="~/master/BaseAdmin.Master" AutoEventWireup="true" CodeBehind="GestionRol.aspx.cs" Inherits="DKintranet.admin.pages.GestionRol" %>
        ...
        <ContentTemplate>
            <asp:Panel ID="pnl_grilla" runat="server">
                ...
                <asp:ObjectDataSource ID="ObjectDataSourceRol" runat="server" SortParameterName="sortExpression"
                    SelectMethod="GetRoles" TypeName="DKintranet.Codigo.clases.AccesoGrilla">
                    <SelectParameters>
