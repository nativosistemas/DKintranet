<%@ Page Title="" Language="C#" MasterPageFile="~/master/BaseAdmin.Master" AutoEventWireup="true" CodeBehind="GestionUsuario.aspx.cs" Inherits="DKintranet.admin.pages.GestionUsuario" %>
        ...
        <ContentTemplate>
            <asp:Panel ID="pnl_grilla" runat="server">
                ...
                <asp:ObjectDataSource ID="odsUsuarios" runat="server" SortParameterName="sortExpression"
                    SelectMethod="GetUsuarios" TypeName="DKintranet.Codigo.clases.AccesoGrilla">
                    <SelectParameters>
            ...
            <asp:Panel ID="pnl_formulario" runat="server" Visible="false">
                ...
                <asp:ObjectDataSource ID="odsRol" runat="server" SelectMethod="RecuperarTodasRoles_Combo"
                    TypeName="DKintranet.Codigo.clases.Seguridad"></asp:ObjectDataSource>
                <asp:ObjectDataSource ID="odsClientes" runat="server" SelectMethod="RecuperarTodosClientesActivosYSinClientes"
                    TypeName="DKintranet.Codigo.clases.FuncionesPersonalizadas"></asp:ObjectDataSource>
            </asp:Panel>
