<%@ Page Title="" Language="C#" MasterPageFile="~/master/BaseAdmin.Master" AutoEventWireup="true" CodeBehind="GestionCatalogo.aspx.cs" Inherits="DKintranet.admin.pages.GestionCatalogo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel ID="pnl_grilla" runat="server">
        ...
        <asp:ObjectDataSource ID="odsNoticia" runat="server" SortParameterName="sortExpression"
            SelectMethod="GetCatalogo" TypeName="DKintranet.Codigo.clases.AccesoGrilla">
            <SelectParameters>
