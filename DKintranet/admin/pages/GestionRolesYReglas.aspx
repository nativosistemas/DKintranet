<%@ Page Title="" Language="C#" MasterPageFile="~/master/BaseAdmin.Master" AutoEventWireup="true" CodeBehind="GestionRolesYReglas.aspx.cs" Inherits="DKintranet.admin.pages.GestionRolesYReglas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:ObjectDataSource ID="odsRol" runat="server" SelectMethod="RecuperarTodasRoles"
        TypeName="DKintranet.Codigo.clases.Seguridad">
        <SelectParameters>
