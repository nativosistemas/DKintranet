<%@ Page Title="" Language="C#" MasterPageFile="~/master/BaseAdmin.Master" AutoEventWireup="true" CodeBehind="GestionCategoriaRestriccion.aspx.cs" Inherits="DKintranet.admin.pages.GestionCategoriaRestriccion" %>
    ...
    <asp:UpdatePanel ID="up_general" runat="server">
        <ContentTemplate>
            <asp:ObjectDataSource ID="odsCadeteriaRestricciones" runat="server" SortParameterName="sortExpression"
                SelectMethod="GetCadeteriaRestricciones" TypeName="DKintranet.Codigo.clases.AccesoGrilla">
                <SelectParameters>
                            ...
                            <div class="form_datos" style="width: 100%;">
                                <div class="ele_abm">
                                    ...
                                    <asp:ObjectDataSource ID="odsSucursales" runat="server" SelectMethod="RecuperarTodasSucursalesSinCategoriaRestriccion"
                                        TypeName="DKintranet.WebService"></asp:ObjectDataSource>
                                </div>
                                <div class="ele_sep">
                                </div>
                                <div class="ele_abm">
