<%@ Page Title="" Language="C#" MasterPageFile="~/master/BaseAdmin.Master" AutoEventWireup="true" CodeBehind="GestionSucursal.aspx.cs" Inherits="DKintranet.admin.pages.GestionSucursal" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel ID="pnl_grilla" runat="server">
     ...
     <asp:ObjectDataSource  ID="odsSucursal"  runat="server" SortParameterName="sortExpression"
                    SelectMethod="GetSucursales" TypeName="DKintranet.Codigo.clases.AccesoGrilla">
                    <SelectParameters>
                        ...
                        <div class="ele_abm">
                            ...
                            <select id="jCmbSucursal" style="width: 300px;" onchange="someFunction();" >
                                <%                       
                                    ...
                                    List<DKintranet.Codigo.capaDatos.cSucursal> listaSucursales = DKintranet.WebService.RecuperarTodasSucursales();
                                    foreach (DKintranet.Codigo.capaDatos.cSucursal item in listaSucursales)
                                    {
