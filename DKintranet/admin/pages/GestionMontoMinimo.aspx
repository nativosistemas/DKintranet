<%@ Page Title="" Language="C#" MasterPageFile="~/master/BaseAdmin.Master" AutoEventWireup="true" CodeBehind="GestionMontoMinimo.aspx.cs" Inherits="DKintranet.admin.pages.GestionMontoMinimo" %>
    ...
    <asp:UpdatePanel ID="up_general" runat="server">
        <ContentTemplate>
            <asp:ObjectDataSource ID="odsSucursalDependiente" runat="server" SelectMethod="GetSucursalesMontoMinimo"
                SortParameterName="sortExpression" TypeName="DKintranet.Codigo.clases.AccesoGrilla">
                <SelectParameters>
