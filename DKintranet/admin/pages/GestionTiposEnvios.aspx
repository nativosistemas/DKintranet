<%@ Page Title="" Language="C#" MasterPageFile="~/master/BaseAdmin.Master" AutoEventWireup="true" CodeBehind="GestionTiposEnvios.aspx.cs" Inherits="DKintranet.admin.pages.GestionTiposEnvios" %>
    ...
    <asp:UpdatePanel ID="up_general" runat="server">
        <ContentTemplate>
            <asp:ObjectDataSource ID="ObjectDataSourceTiposEnvios" runat="server" SortParameterName="sortExpression"
                SelectMethod="GetTiposEnvios" TypeName="DKintranet.Codigo.clases.AccesoGrilla">
                <SelectParameters>
